		...
		<footer className='flex items-center justify-center py-6 sticky top-[100vh]'>
			<div className='text-gray-400 text-xs w-5/6 bg-black bg-opacity-70 rounded-md p-3 text-center'>
				<p>
					...
					on this site is for demonstration and testing of programming and web design skills only. Access to actual
					Netflix content is not provided. The project is for educational purposes.
				</p>
			</div>
		</footer>
	)
